...
- (NSLayoutConstraint * _Nonnull)addCompactConstraint:(NSString * _Nonnull)relationship metrics:(NSDictionary * _Nullable)metrics views:(NSDictionary * _Nullable)views;

// Add any number of constraints. Can also mix in Visual Format Language strings.
- (NSArray<NSLayoutConstraint *> * _Nonnull)addCompactConstraints:(NSArray * _Nonnull)relationshipStrings metrics:(NSDictionary * _Nullable)metrics views:(NSDictionary * _Nullable)views;
